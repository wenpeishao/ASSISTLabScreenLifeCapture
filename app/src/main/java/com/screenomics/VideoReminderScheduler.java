...
public class VideoReminderScheduler extends BroadcastReceiver {
    ...
    public static final String ACTION_VIDEO_REMINDER = "VIDEO_REMINDER_ALARM";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (ACTION_VIDEO_REMINDER.equals(action)) {
            showReminderNotification(context);
            scheduleNextReminder(context);
        } else if (ACTION_DISMISS_REMINDER.equals(action)) {
    ...
    public static void scheduleNextReminder(Context context) {
        ...
        intent.setAction(ACTION_VIDEO_REMINDER);
    ...
    private void showReminderNotification(Context context) {
        ...
        dismissIntent.setAction(ACTION_DISMISS_REMINDER);
