...
public class Constants {
    ...
    public static final String BASE_URL = "https://mindpulse.ssc.wisc.edu";
    public final static String HEALTHCHECK_ADDRESS = "https://mindpulse.ssc.wisc.edu/api/v1/health";
